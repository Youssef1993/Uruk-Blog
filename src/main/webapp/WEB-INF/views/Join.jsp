...
<body>
	...
	<div class="container form-style">
	 <h2><spring:message code="Adduser.Title"/></h2>
	 <br/>
	 ...
	 <br/>
	  ...
	  <div class="col-md-5">
	   <div class="login-area"> <h4><spring:message code="Adduser.LoginText" /></h4>
	    <br/>
	    
	    <a href="<c:url value="/login"/>"><button class="btn btn-success"><i class="fa fa-sign-in" aria-hidden="true"></i>  <spring:message code="Adduser.Login.Button" /></button></a>
	    </div>
	  </div>
    </div>
    <!-- /.content-section-a -->
