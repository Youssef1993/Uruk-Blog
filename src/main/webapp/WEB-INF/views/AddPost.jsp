...
<body>
	...
	<div class="container form-style">
	     ...
	     <h1><spring:message code="NewPost.MainText" /></h1>
	     <br/><br/>
	     <hr>
	     <br/>
	     <form:form modelAttribute="newPost" method="post" id="post-form"  enctype="multipart/form-data">
	       <div class="row">
	       <div class="col-md-6">
	       ...
	       <div class="form-group">
	          ...
	          <form:select path="category" items="${categorys }" class="form-control" />
				...
				<div class="form-group">
					<label class="control-label" for="content"><spring:message code="NewPost.Form.Content" /></label>
				...
				<div class="form-group">
				  ...
				  <form:input type="text" path="tags" class="form-control" placeHolder="Example: java,php,database"/>
				</div>
				
				<div class="form-group">
				  <label for="image"><spring:message code="NewPost.Form.Picture" /></label>
				  <form:input type="file" path="image"/>
				</div>
				
			</form:form>
			<br/><br/>
	   <button class="btn btn-success" id="send">Post</button>
	...
	<script type="text/javascript">
	  ...
	  $(function(){
	    ...
	    $('#send').click(function(){
	    	...
	    	$('#hidden-text-area').val(newtext.trim());
	    	$('#post-form').submit();
	    });
	  });
	</script>
